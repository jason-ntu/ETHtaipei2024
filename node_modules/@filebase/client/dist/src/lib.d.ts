...
export type S3ClientConfig = import('./lib/interface.js').S3ClientConfig;
...
export class FilebaseClient {
     ...
     */
    static storeBlob(service: Service, blob: Blob, objectName?: string | null): Promise<CIDString>;
    /**
     ...
     * @returns {Promise<CIDString>}
     */
    static storeCar({ endpoint, token, s3config, bucket }: Service, car: AsyncIterable<Uint8Array>, objectName: string, { onStoredChunk, onComplete, maxRetries }?: import("./lib/interface.js").CarStorerOptions | undefined): Promise<CIDString>;
    /**
     ...
     * @returns {Promise<CIDString>}
     */
    static storeDirectory(service: Service, filesSource: FilesSource, objectName?: string | null): Promise<CIDString>;
    /**
     ...
     */
    static store<T_1 extends import("./lib/interface.js").TokenInput>(service: Service, metadata: T_1, objectName?: string | null): Promise<import("./lib/interface.js").Token<T_1>>;
    /**
     ...
     */
    static status({ endpoint, token, s3config, bucket }: Service, cid: string, objectName: string | null): Promise<import('./lib/interface.js').StatusResult>;
    /**
     ...
     */
    static delete({ endpoint, token, s3config, bucket }: Service, cid: string, objectName?: string | null): Promise<void>;
    /**
     ...
     */
    constructor({ endpoint, token, s3config, bucket }: {
        token: string;
        endpoint?: string;
    ...
    endpoint: string;
    s3config: import("@aws-sdk/client-s3").S3ClientConfig;
     ...
     * @param {string | null} objectName
     */
    storeBlob(blob: Blob, objectName?: string | null): Promise<import("./lib/interface.js").CIDString>;
    /**
     ...
     * @param {import('./lib/interface.js').CarStorerOptions} [options]
     */
    storeCar(car: AsyncIterable<Uint8Array>, objectName: string, options?: import("./lib/interface.js").CarStorerOptions | undefined): Promise<import("./lib/interface.js").CIDString>;
    /**
     ...
     * @param {string | null} objectName
     */
    storeDirectory(files: FilesSource, objectName?: string | null): Promise<import("./lib/interface.js").CIDString>;
    /**
     * Returns current status of the stored NFT by its CID. Note the NFT must
     * have previously been stored by this account.
     *
     ...
     * @param {string | null} objectName
     */
    status(cid: string, objectName?: string | null): Promise<import("./lib/interface.js").StatusResult>;
    /**
     ...
     * @param {string | null} objectName
     */
    delete(cid: string, objectName?: string | null): Promise<void>;
    /**
     * Stores the given token and all resources it references (in the form of a
     ...
     * @param {string | null} objectName
     */
    store<T extends import("./lib/interface.js").TokenInput>(token: T, objectName?: string | null): Promise<import("./lib/interface.js").Token<T>>;
}
