...
import { mainnet, optimism, arbitrum, avalanche, polygon, bsc, base, sepolia, blast, blastSepolia, avalancheFuji } from 'viem/chains';
import { parseUnits, formatUnits, isAddress, http, createWalletClient, custom, createPublicClient, fallback, stringToHex, keccak256, hexToBytes, getAddress, bytesToHex, maxUint256 } from 'viem';
...
class Client {
  ...
  _getPublicClient(id) {
    ...
    const chain = Object.values(chains).find((chain2) => chain2.id === id);
    if (!chain)
