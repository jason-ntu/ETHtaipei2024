...
exports.parseStateMapping = parseStateMapping;
function parseAccountStateOverride(args) {
    ...
    if (balance !== undefined) {
        rpcAccountStateOverride.balance = (0, toHex_js_1.numberToHex)(balance, { size: 32 });
    }
    if (nonce !== undefined) {
        rpcAccountStateOverride.nonce = (0, toHex_js_1.numberToHex)(nonce, { size: 8 });
    }
    if (state !== undefined) {
...
exports.parseAccountStateOverride = parseAccountStateOverride;
...
exports.parseStateOverride = parseStateOverride;
